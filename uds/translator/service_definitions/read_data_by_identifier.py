"""Translation for ReadDataByIdentifier (SID 0x22) service."""
...
# Common NRCs for ReadDataByIdentifier
_RDBI_NRCS = (
...
READ_DATA_BY_IDENTIFIER_2020 = Service(
    request_sid=RequestSID.ReadDataByIdentifier,
